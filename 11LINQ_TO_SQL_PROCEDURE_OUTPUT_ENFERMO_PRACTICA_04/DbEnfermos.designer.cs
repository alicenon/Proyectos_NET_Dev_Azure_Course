...
namespace _11LINQ_TO_SQL_PROCEDURE_OUTPUT_ENFERMO_PRACTICA_04
{
	...
	public partial class DbEnfermosDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteENFERMO(ENFERMO instance);
		...
		public DbEnfermosDataContext() : 
				base(global::_11LINQ_TO_SQL_PROCEDURE_OUTPUT_ENFERMO_PRACTICA_04.Properties.Settings.Default.HospitalConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public DbEnfermosDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DbEnfermosDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DbEnfermosDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DbEnfermosDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.DEVOLVERENFERMO")]
		public int DEVOLVERENFERMO([global::System.Data.Linq.Mapping.ParameterAttribute(Name="NUMERONSS", DbType="Int")] System.Nullable<int> nUMERONSS, [global::System.Data.Linq.Mapping.ParameterAttribute(Name="APE", DbType="VarChar(25)")] ref string aPE, [global::System.Data.Linq.Mapping.ParameterAttribute(Name="SE", DbType="VarChar(25)")] ref string sE)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), nUMERONSS, aPE, sE);
			aPE = ((string)(result.GetParameterValue(1)));
			sE = ((string)(result.GetParameterValue(2)));
