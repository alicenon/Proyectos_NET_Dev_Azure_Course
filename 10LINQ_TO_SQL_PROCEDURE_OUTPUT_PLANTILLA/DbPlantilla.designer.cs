...
namespace _10LINQ_TO_SQL_PROCEDURE_OUTPUT_PLANTILLA
{
    ...
    partial void DeletePLANTILLA(PLANTILLA instance);
		...
		public DbPlantillaDataContext() : 
				base(global::_10LINQ_TO_SQL_PROCEDURE_OUTPUT_PLANTILLA.Properties.Settings.Default.HospitalConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.DATOSPLANTILLA")]
		public int DATOSPLANTILLA([global::System.Data.Linq.Mapping.ParameterAttribute(Name="TURNO", DbType="VarChar(1)")] string tURNO, [global::System.Data.Linq.Mapping.ParameterAttribute(Name="MEDIA", DbType="Int")] ref System.Nullable<int> mEDIA, [global::System.Data.Linq.Mapping.ParameterAttribute(Name="SUMA", DbType="Int")] ref System.Nullable<int> sUMA)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), tURNO, mEDIA, sUMA);
			mEDIA = ((System.Nullable<int>)(result.GetParameterValue(1)));
